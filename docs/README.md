...
- URL: https://huggingface.co/spaces/Chris4K/sentiment-model-comparison
- SDK: gradio
...
1. **Private Monorepo** (development)
   - Location: `apps/huggingface/sentiment-model-comparison/`
   - All development happens here
   - Contains secrets and private configuration

2. **Public GitHub Repository**
   - URL: https://github.com/Ckal/sentiment-model-comparison
